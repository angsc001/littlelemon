...
function Main (){
    ...
    return(
        ...
        ">
            ...
            <h1 class="align-start font-prim font-medium text-5xl ml-5 mb-1 text-seconf col-start-1
            md:text-4xl">
                Chicago
            </h1>
            ...
            md:mb-20 lg:mt-5 lg:mb-20 hover:text-btnbg hover:bg-seconf"
            onClick={handleClick}>
                Reserve a Table
            </button>
            <img class="object-cover w-96 h-96 rounded-3xl m-5
            md:h-80 md:w-80 md:row-span-3 md:row-start-2 md:col-start-2 md:top-64 md:left-2/4 lg:absolute lg:top-56 lg:left-2/4 lg:m-0 lg:h-96 lg:w-96" src= {image}/>
         </main>
        </html>
